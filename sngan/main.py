...
def parse_args():
    ...
    parser.add_argument('--disc-h-size', default=64)
    parser.add_argument('--z-size', default=128)
    parser.add_argument('--lr', default=0.0002)
    parser.add_argument('--beta1', default=0.5, help='Adam parameter')
    parser.add_argument('--beta2', default=0.9, help='Adam parameter')
    parser.add_argument('--n-dis', default=5, help='Number of discriminator interation for each generator interation')
